...
when those names comprise multiple words, whereby the first letter of the first word is lowercase
but the first letter of each subsequent word is uppercase. For instance,
...
def snake_case(camel):
    for letter in range(len(camel)):
        while camel[letter].isupper():
            print("_", end='')
            break
        word = camel[letter]
